...
export const areCollectionsFetchingSelector = createSelector([shopSelector], shop => shop.isFetching);

export const areCollectionsLoadedSelector = createSelector([shopSelector], shop => !!shop.collections);
